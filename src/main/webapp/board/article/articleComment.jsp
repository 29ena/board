		...
		<%@include file="/common/left.jsp" %>
			<div class="table-responsive">
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<form id = "frm" class="form-hrizontal" role="form" action="${pageContext.request.contextPath }/articleComment"
								method="post" enctype="multipart/form-data">
	                 			<input type="hidden"  name="article_id" value="${articleVo.article_id }"/> 
	                 			<input type="hidden"  name="article_pid" value="${articleVo.article_pid }"/>
	                 			<input type="hidden"  name="article_board" value="${articleVo.article_board }"/>
					<table class="table table-striped">
						<tr>
						<td><label>제목</label></td>
						<td><input class="form-control" id="aricle_title" name="article_title" type="text"/></td>
						</tr>
						<tr>
						<td>글 내용</td>
						<td>
			   				...
			   				<textarea name="article_content" id="smarteditor" rows="10" cols="100" 
			   								style="width:750px; height:412px;">원본내용 : ${articleVo.article_content }</textarea> 
