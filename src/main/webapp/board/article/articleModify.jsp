		...
		<%@include file="/common/left.jsp" %>
			<div class="table-responsive">
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<form id = "frm" class="form-hrizontal" role="form" action="${pageContext.request.contextPath }/articleModify"
					...
					<table class="table table-striped">
						...
						<td><input class="form-control" id="aricle_title" name="article_title" type="text" value="${vo.article_title }"/></td>
						</tr>
						<tr>
						<td>글 내용</td>
						<td>
			   				<textarea name="article_content" id="smarteditor"  rows="10" cols="100" 
			   								style="width:750px; height:412px;">${vo.article_content }</textarea> 
						</td>
						</tr>	
						<tr>
						 ...
						 <div class="form-group col-sm-4">
	                        <div>
		                        <c:forEach items="${fileList }" var="list">
	                        		<label class="filelable">${list.attach_name}</label>&nbsp;&nbsp;&nbsp;&nbsp;
	                        		<button id="removeBtn" class="btn btn-default" type="button">삭제</button><br> 
	                        		<input type="hidden" value = "${list.attach_id }" />
	                        	</c:forEach>
	                        </div>
